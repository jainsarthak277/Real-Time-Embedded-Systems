...
void main(void)
{
    ...
    printf("Start Time:[%lu]Starting High Rate Sequencer Demo\n",TimeStamp());
   ...
   printf("Using CPUS=%d from total available.\n", CPU_COUNT(&allcpuset));
    ...
    if(rc < 0)
        ...
        printf("Time Stamp:[%llu]pthread_create successful for service 1\n",TimeStamp());
    ...
    if(rc < 0)
        ...
        printf("Time Stamp:[%llu]pthread_create successful for service 2\n",TimeStamp());
    ...
    if(rc < 0)
        ...
        printf("Time Stamp:[%llu]pthread_create successful for service 3\n",TimeStamp());
    ...
    if(rc < 0)
        ...
        printf("Time Stamp:[%llu]pthread_create successful for service 4\n",TimeStamp());
    ...
    if(rc < 0)
        ...
        printf("Time Stamp:[%llu]pthread_create successful for service 5\n",TimeStamp());
    ...
    if(rc < 0)
        ...
        printf("Time Stamp:[%llu]pthread_create successful for service 6\n",TimeStamp());
    ...
    if(rc < 0)
        ...
        printf("Time Stamp:[%llu]pthread_create successful for service 7\n",TimeStamp());
...
void *Service_1(void *threadp)
{
    ...
    //printf("Start Time for Service 1 [%lu]\n\r",TimeStamp());
    ...
    stop=TimeStamp();
    printf("The difference in time %llu \n\r ",stop-start);
...
void *Service_2(void *threadp)
{
  ...
  // start=TimeStamp(); 
   ...
   // printf("Start Time for Service 2 [%lu]\n\r",TimeStamp());
...
void *Service_3(void *threadp)
{
  ...
  //  start=TimeStamp(); 
    //printf("Start Time for Service 3 [%lu]\n\r",TimeStamp());
...
void *Service_4(void *threadp)
{
 ...
 //  start=TimeStamp(); 
   // printf("Start Time for Service 4 [%lu]\n\r",TimeStamp());
...
void *Service_5(void *threadp)
{
  ...
  //  start=TimeStamp();  
    // printf("Start Time for Service 5 [%lu]\n\r",TimeStamp());
...
void *Service_6(void *threadp)
{
  ...
  //  start=TimeStamp(); 
    //printf("Start Time for Service 6 [%lu]\n\r",TimeStamp());
...
{   
    ...
    printf("Start Time for Service 7 [%lu]\n\r",TimeStamp());
