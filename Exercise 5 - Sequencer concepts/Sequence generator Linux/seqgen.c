...
void main(void)
{
   ...
   printf("Start Time:[%lu] System has %d processors configured and %d available.\n", TimeStamp(),get_nprocs_conf(), get_nprocs());
   ...
   printf("[%lu] Using CPUS=%d from total available.\n",TimeStamp(), CPU_COUNT(&allcpuset));
    ...
    printf("[%lu] Service threads will run on %d CPU cores\n", TimeStamp(),CPU_COUNT(&threadcpu));
    ...
    if(rc < 0)
        ...
        printf("Start Time:[%lu]pthread_create successful for service 1\n",TimeStamp());
    ...
    if(rc < 0)
        ...
        printf("Start Time:[%lu]pthread_create successful for service 2\n",TimeStamp());
    ...
    if(rc < 0)
        ...
        printf("Start Time:[%lu]pthread_create successful for service 3\n",TimeStamp());
    ...
    if(rc < 0)
        ...
        printf("Start Time:[%lu]pthread_create successful for service 4\n",TimeStamp());
    ...
    if(rc < 0)
        ...
        printf("Start Time:[%lu]pthread_create successful for service 5\n",TimeStamp());
    ...
    if(rc < 0)
        ...
        printf("Start Time:[%lu]pthread_create successful for service 6\n",TimeStamp);
    ...
    if(rc < 0)
        ...
        printf("Start Time:[%lu]pthread_create successful for service 7\n",TimeStamp());
...
void *Service_1(void *threadp)
{
    ...
    stop=TimeStamp();
    printf("The difference in time for service 4 %llu \n\r ",stop-start);
  //  printf("Stop Time for Service 1 [%lu]\n\r",TimeStamp());
    pthread_exit((void *)0);
   // printf("Stop Time for Service 1 [%d]\n\r",TimeStamp());
}
...
void *Service_2(void *threadp)
{
    ...
    stop=TimeStamp();
    printf("The difference in time for service 2 %llu \n\r ",stop-start);
  //  printf("Stop Time for Service 2 [%lu]\n\r",TimeStamp());
    pthread_exit((void *)0);
   // printf("Stop Time for Service 2 [%d]\n\r",TimeStamp());
}
...
void *Service_3(void *threadp)
{
    ...
    stop=TimeStamp();
    printf("The difference in time for service 3 %llu \n\r ",stop-start);
   // printf("Stop Time for Service 3 [%lu]\n\r",TimeStamp());
    pthread_exit((void *)0);
  //  printf("Stop Time for Service 1 [%d]\n\r",TimeStamp());
}
...
void *Service_4(void *threadp)
{
    ...
    stop=TimeStamp();
    printf("The difference in time for service 4 %llu \n\r ",stop-start);
   // printf("Stop Time for Service 4 [%lu]\n\r",TimeStamp());
    pthread_exit((void *)0);
}
...
void *Service_5(void *threadp)
{
    ...
    stop=TimeStamp();
    printf("The difference in time for service 5 %llu \n\r ",stop-start);
 //   printf("Stop Time for Service 5 [%lu]\n\r",TimeStamp());
    pthread_exit((void *)0);
}
...
void *Service_6(void *threadp)
{
    ...
    stop=TimeStamp();
    printf("The difference in time for service 6 %llu \n\r ",stop-start);
  //  printf("Stop Time for Service 6 [%lu]\n\r",TimeStamp());
    pthread_exit((void *)0);
}
...
void *Service_7(void *threadp)
{
    ...
    stop=TimeStamp();
    printf("The difference in time for service 7 %llu \n\r ",stop-start);
  //  printf("Stop Time for Service 7 [%lu]\n\r",TimeStamp());
    pthread_exit((void *)0);
}
